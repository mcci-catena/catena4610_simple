...
Name:   catena-message-port1-format-14-1A-decoder-node-red.js

Function:
    Decode port 0x01 format 0x14, 0x1A messages for TTN console.

Copyright and License:
    See accompanying LICENSE file at https://github.com/mcci-catena/catena4610_simple/

Author:
    Dhinesh Kumar Pitchai, MCCI Corporation   March 2024
...
// end of insertion of catena-message-port1-format-14-1A-decoder-ttn.js
...
if (result === null) {
    ...
    var eMsg = "not port 1/fmt 0x14|0x1A! port=" + msg.port.toString();
    if (port === 1) {
...
msg.local =
    {
        nodeType: "Catena 4610",
        platformType: "Catena 4610",
        radioType: "Murata",
        applicationName: "Environmental sensor fmt 0x14/0x1A"
    };
